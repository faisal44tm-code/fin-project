...
# الصفحة الرئيسية (اللي فيها الفراغات)
@app.route('/')
def home():
    return '''
    <!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <h1 style="color: #333;">نظام تحليل البيانات الذكي</h1>
            ...
            <form action="/analyze" method="post">
                ...
                <button type="submit">بدء عملية التحليل</button>
            </form>
        </div>
    </body>
    </html>
...
# صفحة النتيجة (اللي تطلع فيها النسب)
@app.route('/analyze', methods=['POST'])
def analyze():
    user_name = request.form.get('name')
    # توليد نسبة عشوائية بين 75% و 99%
    ...
    <body>
        <div class="result-box">
            ...
            <p style="color: #555;">تم التحليل بنجاح بناءً على البيانات المدخلة.</p>
            <br>
            <a href="/">إجراء تحليل جديد</a>
        </div>
    </body>
    </html>
    '''
